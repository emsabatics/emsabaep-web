            ...
            <div class="col-lg-12 main-container">
                <div class="cards">
                    ...
                    <div class="card card-emsaba">
                        ...
                        <p class="card__apply">
                            <a class="card__link" href="javascript:void(0)" onclick="view_open_video('{{ encriptarNumero($subcat->id) }}')">Ver más <i class="fas fa-arrow-right ml-4"></i></a>
                        </p>
                    </div>
                    @endforeach
                </div>
