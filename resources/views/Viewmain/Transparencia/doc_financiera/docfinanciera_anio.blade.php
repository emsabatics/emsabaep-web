    ...
    <div class="container py-5">
        <div class="mx-auto text-center mb-5" style="max-width: 900px;">
            <h5 class="section-title px-3">
                BIBLIOTECA DE TRANSPARENCIA - DOCUMENTACIÓN FINANCIERA
            </h5>
        </div>
            ...
            <div class="col-lg-12 main-container">
                <div class="cards">
                    ...
                    <div class="card card-emsaba">
                        ...
                        <p class="card__apply">
                          <a class="card__link" href="javascript:void(0)" onclick="view_docfin('{{encriptarNumero($y->code)}}')">Ver más <i class="fas fa-arrow-right ml-4"></i></a>
                        </p>
                    </div>
                    @endforeach
                </div>
        ...
        <div class="row g-4 bg-light align-items-center">
            <div class="co-lg-12">
                ...
                <div class="btn-group">
                    <button class="btn-p btn-intermediate" onclick="comeback_docfin()"><i class="fas fa-arrow-left mr-4"></i> Regresar</button>
                </div>
            </div>
        </div>
    </div>
