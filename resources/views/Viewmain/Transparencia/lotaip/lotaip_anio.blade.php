    ...
    <div class="container py-5">
        <div class="mx-auto text-center mb-5" style="max-width: 900px;">
            <h5 class="section-title px-3">
                BIBLIOTECA DE TRANSPARENCIA - LOTAIP
            </h5>
        </div>
            ...
            <div class="col-lg-12 main-container">
                <div class="cards">
                    ...
                    <div class="card card-emsaba">
                        ...
                        <p class="card__apply">
                          <a class="card__link" href="javascript:void(0)" onclick="viewdetail('{{encriptarNumero($y->code)}}')">Ver más <i class="fas fa-arrow-right ml-4"></i></a>
                        </p>
                    </div>
                    @endforeach
                </div>
