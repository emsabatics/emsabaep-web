...
<div class="container-fluid contact bg-light py-5">
    <div class="container py-5">
            ...
            <div class="col-8">
                ...
                <div id="accordion" class="myaccordion">
                    ...
                    <!--<div class="card mt-2">
                        <div class="card-header" id="headingOne">
                            <h2 class="mb-0">
                                <button class="d-flex align-items-center justify-content-between btn btn-link" data-toggle="collapse" data-target="#collapse-2024-Febrero" aria-expanded="true" aria-controls="collapse-2024-Febrero">
                                  Febrero
                                  <span class="fa-stack fa-sm">
                                    <i class="fas fa-circle fa-stack-2x"></i>
                                    <i class="fas fa-plus fa-stack-1x fa-inverse"></i>
                        ...
                        <div id="collapse-2024-Febrero" class="collapse" aria-labelledby="heading2024-Febrero" data-parent="#accordion">
                            <div class="card-body">
                                <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Porro sint dolorum iure minus numquam natus esse id necessitatibus 
                                    voluptate eaque delectus, magnam laudantium aut quae, consequatur nobis eligendi, veritatis dicta!</p>
                            </div>
                        </div>
                    </div>-->
                </div>
        ...
        <div class="row g-4 bg-light align-items-center mt-2">
            <div class="co-lg-12">
                <div class="btn-group">
                    <button class="btn-p btn-intermediate" onclick="comeback_list(1)"><i class="fas fa-arrow-left mr-4"></i> Regresar</button>
                </div>
            </div>
        </div>
    </div>
