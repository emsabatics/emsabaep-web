    ...
    <div class="container py-5">
        <div class="mx-auto text-center mb-5" style="max-width: 900px;">
            <h5 class="section-title px-3">
                BIBLIOTECA DE TRANSPARENCIA - AUDITORÍA
            </h5>
        </div>
        @if(count($anio_auditoria)>0)
        <div class="row g-4 align-items-center">
            <div class="col-lg-12 main-container">
                <div class="cards">
                    @foreach ($anio_auditoria as $y)
        ...
        <div class="row g-4 bg-light align-items-center">
            <div class="co-lg-12">
                ...
                <div class="btn-group">
                    <button class="btn-p btn-intermediate" onclick="comeback_docauditoria()"><i class="fas fa-arrow-left mr-4"></i> Regresar</button>
                </div>
            </div>
        </div>
    </div>
