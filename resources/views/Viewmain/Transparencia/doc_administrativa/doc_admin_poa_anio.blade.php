    ...
    <div class="container py-5">
        <div class="mx-auto text-center mb-5" style="max-width: 900px;">
            <h5 class="section-title px-3">
                DOCUMENTACIÓN ADMINISTRATIVA - POA
            </h5>
        </div>
        @if(count($anio_docpoa)>0)
        <div class="row g-4 align-items-center">
            <div class="col-lg-12 main-container">
                <div class="cards">
                    @foreach ($anio_docpoa as $y)
                    <div class="card card-emsaba">
                        <div class="card__icon"><i class="fas fa-tint"></i></div>
                        <p class="card__exit"><i class="fas fa-times"></i></p>
                        <h2 class="card__title">Año {{$y->anio}}</h2>
                        <p class="card__apply">
                          <a class="card__link" href="javascript:void(0)" onclick="view_docpoa('{{encriptarNumero($y->code)}}')">Ver más <i class="fas fa-arrow-right ml-4"></i></a>
                        </p>
                    </div>
                    @endforeach
                </div>
