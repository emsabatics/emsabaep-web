...
<style>
    ...
    .myaccordion .container-iframe .responsive-iframe {
        position: absolute;
        top: 0;
        left: 0;
        bottom: 0;
    ...
    <div class="container py-5">
        <div class="mx-auto text-center mb-5" style="max-width: 900px;">
            <h5 class="section-title px-3">
                DOCUMENTACIÓN ADMINISTRATIVA - PROCESOS SERCOP
            </h5>
        </div>
        <div class="row g-4 align-items-center mb-2">
            <div class="col-lg-12">
                @foreach ($procesoc as $item)
                <div id="accordion" class="myaccordion" style="max-width: 1200px;">
                    <div class="card container-iframe mt-2">
                        <iframe src="{{$item->enlace}}" frameborder="0" height="1000" width="1200" name="procesos" class="responsive-iframe">
        ...
        <div class="row g-4 bg-light align-items-center mt-2">
            <div class="co-lg-12">
                <div class="btn-group">
                    <button class="btn-p btn-intermediate" onclick="comeback_administrativo()"><i class="fas fa-arrow-left mr-4"></i> Regresar</button>
                </div>
            </div>
        </div>
    </div>
