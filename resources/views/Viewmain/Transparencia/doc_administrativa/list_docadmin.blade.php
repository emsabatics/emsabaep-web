...
<div class="container-fluid contact bg-light py-5">
    <div class="container py-5">
        <div class="mx-auto text-center mb-5" style="max-width: 900px;">
            @foreach ($docadmin as $i)
            <h5 class="section-title px-3">
                DOCUMENTACIÓN ADMINISTRATIVA - AÑO {{$i['anio']}}
            </h5>
            @endforeach
        </div>
        ...
        <div class="row g-4 bg-light align-items-center mt-2">
            <div class="co-lg-12">
                <div class="btn-group">
                    <button class="btn-p btn-intermediate" onclick="comeback_listdocadmin()"><i class="fas fa-arrow-left mr-4"></i> Regresar</button>
                </div>
            </div>
        </div>
    </div>
