    ...
    <div class="container py-5">
        ...
        <div class="row g-4 align-items-center">
            <div class="col-lg-12 main-container">
                <div class="cards">
                    @foreach ($categoria as $y)
                    <div class="card card-emsaba">
                        <div class="card__icon"><i class="fas fa-tint"></i></div>
                        <p class="card__exit"><i class="fas fa-times"></i></p>
                        <h2 class="card__title">{{$y->descripcion}}</h2>
                        <p class="card__apply">
                          <a class="card__link" href="javascript:void(0)" onclick="view_subcatdocopt('{{encriptarNumero($y->id)}}')">Ver más <i class="fas fa-arrow-right ml-4"></i></a>
                        </p>
                    </div>
                    @endforeach
                </div>
