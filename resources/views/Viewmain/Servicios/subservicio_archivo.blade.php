        ...
        <div class="row g-4 align-items-center mb-2" style="padding: 0 50px;">
            <div class="col-12">
                @if(count($detallesubservice)>0)
                    @foreach($detallesubservice as $it)
                        @if ($it['posicion']=='inicio')
                        <div class="row mb-4">
                            <div class="col-12 colImgHistory">
                                <div style="height: auto;width: auto;">
                                    @if($it['tipo_file']!='' || $it['tipo_file']!=null)
                                        @if($it['tipo_file']=='image')
                                            <img src="/servicios-img/{{$it['archivo']}}" alt="{{$it['archivo']}}">
                                        @elseif($it['tipo_file']=='pdf')
                                            <div class="container-iframe">
                                                <object data="/servicios-img/{{$it['archivo']}}" type="application/pdf" width="600" height="800"></object>
                                            </div>
                                        @endif
                                    @endif
                                </div>
                        ...
                        @elseif($it['posicion']=='' && $it['descripcion']!='')
                        <div class="row">
                            <div class="col-12">
                                {!! $it['descripcion'] !!}
                            </div>
