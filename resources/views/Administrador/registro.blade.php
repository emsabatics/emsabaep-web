...
<body class="hold-transition register-page setBgContent">
  ...
  <div class="register-box">
    <div class="card card-outline card-primary">
      ...
      <div class="card-body">
        ...
        <form id="formDataRegistro" class="mb-3">
          <div class="input-group mb-3">
            <input type="text" class="form-control" placeholder="Nombres Completos" autocomplete="off"
              id="nameUsuario" name="nameUsuario">
        ...
        <div class="row mb-3">
          <!-- /.col -->
          <div class="col-12">
            <button class="btn btn-primary btn-block" id="btnRegistroAdmin">Registrar</button>
          </div>
          <!-- /.col -->
        </div>
  ...
  <script src="{{asset('assets/administrador/js/registroadmin.js')}}"></script>
</body>
</html>