                          ...
                          @foreach ($datos_user as $us)
                                  ...
                                  <input type="hidden" name="idusuario" id="idusuario" value="{{encriptarNumero($us->id)}}">
                                    <div class="form-group">
                                      ...
                                      <input type="text" class="form-control" id="inputENameUser" placeholder="Nombres Completos"
                                          autocomplete="off" value="{{$us->nombre_usuario}}">
                                    </div>
                                    <div class="form-group noevent">
                                      <label for="inputEUsuario">Usuario</label>
                                      <input type="text" class="form-control" id="inputEUsuario" placeholder="Usuario"
                                          autocomplete="off" value="{{$us->user}}">
                                    </div>
                                    <div class="form-group">
                                      <label for="selectETypeUser">Tipo Usuario</label>
                                      <select name="selectETypeUser" id="selectETypeUser" class="form-control">
                                        <option value="0">-Seleccione una Opción-</option>
                                        @foreach ($perfiluser as $item)
                                          @if ($us->tipo_usuario == $item->id)
                            ...
                            <div class="row">
                                <div class="col-lg-12 mt-4 d-flex justify-content-end">
                                  <button type="button" class="btn btn-primary" style="font-size: 16px;" onclick="actualizarUsuario()">
