      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <h3 class="card-title p-2"><i class="fas fa-file-contract mr-3"></i> Documentación LOTAIP V2</h3>
            ...
            <div class="card-body table-responsive p-4" id="divDocVirtual">
              ...
              <div class="row">
                @foreach ($totalByYear as $r)
                  <div class="col-md-4 col-sm-6 col-12">
                    <div class="info-box">
                      <span class="info-box-icon bg-info"><i class="fas fa-download"></i></span>

                      <div class="info-box-content">
                        <span class="info-box-text">{{$r['anio']}}</span>
                        <span class="info-box-number">{{$r['total_anual']}}</span>
                      </div>
                      <!-- /.info-box-content -->
                    </div>
                    <!-- /.info-box -->
        ...
        <div class="card">
          <div class="card-body">
            <div class="d-flex">
              ...
              <div id="graficoDescargasLotaip" style="width:100%; height:400px;"></div>
            </div>
          </div>
        </div>
      </div>
                                ...
                                <div class="p-0">
                                  <table class="table table-hover">
                                    <tbody>
                                      ...
                                      @if (count($rm['archivos'])  > 0)
                                      @foreach ($rm['archivos'] as $rfile)
                                        <tr>
                                          <td>{{$rfile['articulo']}}</td>
                                          <td>{{$rfile['titulo']}}</td>
...
<script>
  const valores = @json($datatochart);

  $(document).ready(function () {
    configChart();
    $('#modalCargando').modal('show');
    setTimeout(() => {
      loadDatLotaipv2(valores);
