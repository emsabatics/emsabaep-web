      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <h3 class="card-title p-2"><i class="fas fa-file-contract mr-3"></i> Documentación de Auditría</h3>
        ...
        <div class="card">
          <div class="card-body">
            <div class="d-flex">
              ...
              <div id="graficoDescargasDocAud" style="width:100%; height:400px;"></div>
            </div>
          </div>
        </div>
      </div>
...
<script>
  ...
  $(document).ready(function () {
    ...
    setTimeout(() => {
      loadDataDocAudt(categorias,valores);
