      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <h3 class="card-title p-2"><i class="fas fa-file-contract mr-3"></i> Reglamentos / Ley</h3>
        ...
        <div class="card">
          <div class="card-body">
            <div class="d-flex">
              ...
              <div id="graficoDescargasLey" style="width:100%; height:400px;"></div>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="card-body p-0">
            <table class="table table-hover">
              <tbody id="tabla-datos">
                ...
                <tr>
                  <td class="border-0">{{$res->titulo}}</td>
                  <td class="border-0">{{$res->total}}</td>
                </tr>
                @endforeach
              </tbody>
            </table>
...
<script>
  ...
  const categorias = datos.map(item => item.titulo);
  ...
  $(document).ready(function () {
    ...
    setTimeout(() => {
      loadDataLey(categorias,valores);
