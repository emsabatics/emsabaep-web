      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <h3 class="card-title p-2"><i class="fas fa-file-contract mr-3"></i> Documentación de Rendición de Cuentas</h3>
            ...
            <div class="card-body table-responsive p-4" id="divDocVirtual">
              ...
              <div class="row">
                @foreach ($totalportipo as $rct)
                  <div class="col-md-4 col-sm-6 col-12">
                    <div class="info-box">
                      <span class="info-box-icon bg-info"><i class="fas fa-download"></i></span>
                      @if ($rct->tipo=='medio')
                      <div class="info-box-content">
                        <span class="info-box-text">Medios</span>
                        <span class="info-box-number">{{$rct->total}}</span>
                      </div>
                      @elseif($rct->tipo=='video')
                      <div class="info-box-content">
        ...
        <div class="card">
          <div class="card-body">
            <div class="d-flex">
              ...
              <div id="graficoDescargasRC" style="width:100%; height:400px;"></div>
            </div>
          </div>
        </div>
      </div>
                ...
                <tr class="expandable-body">
                  <td>
                    <div class="p-0">
                      <table class="table table-hover">
                        <tbody>
                          @foreach ($res['categorias'] as $rcat)
                            @if ($rcat['tipo']=='medio')
                              <tr data-widget="expandable-table" aria-expanded="false">
                                <td>
                                  <i class="expandable-table-caret fas fa-caret-right fa-fw"></i>
                                  ...
                                  <div class="p-0">
                                    <table class="table table-hover">
                                      <tbody>
                                        ...
                                        @foreach ($rcat['archivos'] as $rfile)
                                          <tr>
                                            <td>{{$rfile['titulo']}}</td>
                                            <td>{{$rfile['contador']}}</td>
                                          </tr>
                                        @endforeach
                                        <tr>
                                          <td><b>Total</b></td>
                                          <td><b>{{$rcat['total']}}</b></td>
                                        </tr>
                                      </tbody>
                                    </table>
                                  </div>
...
<script>
  ...
  $(document).ready(function () {
    ...
    setTimeout(() => {
      loadDataRC(categories,seriesData);
