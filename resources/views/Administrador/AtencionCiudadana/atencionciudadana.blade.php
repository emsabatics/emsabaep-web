                    ...
                    <table class="table datatables" id="tablaDocAdmin">
                      ...
                      <tbody>
                        ...
                        <tr id="Tr{{$loop->index}}">
                          ...
                          <td>{{$item['fecha']}}</td>
                          <td>
                            <span class="badge badge-success">{{$item['estado_mensaje']}}</span>
                          </td>
                          <td>{{$item['nombre_usuario']}}</td>
                          <td class="project-actions text-right">
                            <a class="btn btn-primary btn-sm mt-2 mr-3" href="javascript:void(0)" onclick="seguimientosolicitud('{{encriptarNumero($item['id'])}}')">
                            ...
                            @else
                            <a class="btn btn-success btn-sm mt-2 mr-3" href="javascript:void(0)" onclick="activarDocAdmin({{$item['id']}}, {{$loop->index}})">
