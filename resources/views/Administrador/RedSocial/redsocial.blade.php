                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="cardsRowTitle">
                            ...
                            <div class="cardsection">
                              <button type="button" class="btn btn-warning btn-block" onclick="addRedSocial()"><i
...
<!--MODAL AGG CONTACTO SOCIAL MEDIA-->
<div class="modal fade" id="modalAggSocial" tabindex="-1" role="dialog" aria-labelledby="modalArchivosTitle"
aria-hidden="true" data-backdrop="static" data-keyboard="false" data-bs-focus="false">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Agregar Contacto (Red Social)</h4>
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <select class="form-control select2" id="selSocialMedia" >
                        <optgroup label="Seleccione una Red Social">
                            <option value="0">-Seleccione una Opción-</option>
                            @foreach ($redsocial as $item)
                            ...
                            <!--<option value="nueva">Add Nueva Red Social</option>-->
                        </optgroup>
                        </select>
                    </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" id="inputUsuario" class="form-control" placeholder="Usuario" autocomplete="off">
                    </div>
                    </div>
                </div>
                <br>
                <div class="row">
                    <div class="col-lg-12">
                    <label for="textsocialmedia">Enlace:</label>
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
                        <span class="input-group-text" id="span-socialmedia">Social</span>
                        </div>
                        <input type="text" class="form-control" id="textsocialmedia" aria-describedby="span-socialmedia" autocomplete="off">
                    </div>
                    </div>
                </div>
            </div>
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary mb-2" onclick="guardarRegistroRS()">Guardar</button>
            </div>
        </div>
        <!-- /.modal-content -->
    </div>
...
<!--MODAL EDIT CONTACTO SOCIAL MEDIA-->
<div class="modal fade" id="modalEditSocial" tabindex="-1" role="dialog" aria-labelledby="modalArchivosTitle"
aria-hidden="true" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title">Editar Contacto (Red Social)</h4>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <div class="row">
          <div class="col-lg-12">
            <input type="hidden" id="idsocialmedia">
            <div class="form-group mb-3">
              <label for="inputEsocialmedia">Red Social:</label>
              <input type="text" id="inputEsocialmedia" class="form-control" placeholder="Social Media" autocomplete="off" style="pointer-events:none;">
            </div>
          </div>
        </div>
        <br>
        <div class="row">
          <div class="col-lg-12">
            <div class="form-group mb-3">
              <label for="inputEUsuario">Usuario:</label>
              <input type="text" id="inputEUsuario" class="form-control" placeholder="Usuario" autocomplete="off">
            </div>
          </div>
        </div>
        <br>
        <div class="row">
          <div class="col-lg-12">
            ...
            <div class="input-group mb-3">
              <div class="input-group-prepend">
                <span class="input-group-text" id="span-Esocialmedia">Social</span>
              </div>
              <input type="text" class="form-control" id="textEsocialmedia" aria-describedby="span-socialmedia" autocomplete="off">
            </div>
          </div>
        </div>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary mb-2" data-dismiss="modal">Cerrar</button>
        <button type="button" class="btn btn-primary mb-2" onclick="actualizarRegistroRedS()">Actualizar</button>
      </div>
    </div>
    <!-- /.modal-content -->
  </div>
...
<script>
    ...
    var socialmedia= {{Illuminate\Support\Js::from($socialmedia)}};
    ...
    setTimeout(() => {
        ...
        getListadoSocialMedia(socialmedia);
