...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
              <form id="formEditHistoria" method="POST" enctype="multipart/form-data">
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 mt-4" id="imagesBD">
                        
                    </div><!--COL-LG-4-->
                    <div class="col-lg-4 mt-4" id="divUpNewImgHistory" style='display:none;'>
                        <div class="form-group mb-3">
                          <span class="spanlabel">Debe elegir solo una imagen</span>
                          <div class="container">
                            <input type="file" name="file[]" id="file" accept="image/*" onchange="preview()" multiple>
                ...
                <div class="row">
                  <div class="col-lg-12 mt-4 d-flex justify-content-end">
                    <button type="button" class="btn btn-primary button-save-historia" style="font-size: 16px;" onclick="actualizarHistoria()">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-body text-center">
                ...
                <br><br>
                <p style="font-size: 16px;"> Actualizando Historia... </p>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    cargar_historia(varImg, varTexto);
  </script>
@endsection