                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group mb-3">
                        <label for="inputNameLocation">Nombre</label>
                        <textarea class="form-control text-justify" id="inputNameLocation" placeholder="Ingrese un Nombre" rows="2" cols="5" maxlength="270"></textarea>
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group mb-3">
                        <label for="inputDireccionLocation">Dirección</label>
                        <textarea class="form-control text-justify" id="inputDireccionLocation" placeholder="Ingrese una dirección" rows="2" cols="5" maxlength="270"></textarea>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-lg-12 d-flex justify-content-end">
                      <button type="button" class="btn btn-primary btn-block" onclick="guardarNewLocation()" style="width: 12%;" id="btnSaveNewLocation"><i
