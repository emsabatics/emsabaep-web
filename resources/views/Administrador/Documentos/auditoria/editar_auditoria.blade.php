...
@section('title-page')
Admin | AUDITORIA {{getNameInstitucion()}}
@endsection
          ...
          <div class="col-12">
              <div class="card card-default">
                  <div class="card-header">
                      <h3 class="card-title">Editar Auditoría</h3>
                  ...
                  <div class="card-body">
                      <form id="formE_auditoria" action="" method="POST" enctype="multipart/form-data">
                          @foreach ($fileauditoria as $p)
                          <div class="row">
                              <div class="col-6">
                                  <div class="form-group noevent">
                                    <input type="hidden" name="idauditoria" id="idauditoria" value="{{$p->id}}">
                                    <label>Año:</label>
                                    <select class="form-control select2" id="selYearEAuditoria" name="selYearEAuditoria">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <textarea class="form-control text-justify" id="inputETitulo" name="inputETitulo" placeholder="Ingrese un título"
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                      ...
                                      <textarea id="inputEAliasFile" name="inputEAliasFile" class="form-control text-justify noevent" placeholder="Ingrese un alias" 
                                        maxlength="70">{{substr($p->archivo, 0, -4);}}</textarea>
                                    </div>
                                  </div>

                                  <div class="card-list grid-card-list" id="cardListAuditoria">
                              ...
                              <div class="col-6">
                                  <div class="form-group mb-3 noshow" id="divfileauditoria">
                          ...
                          <div class="row">
                              <div class="col-lg-12 mt-4 d-flex justify-content-end">
                                <button type="button" class="btn btn-primary" style="font-size: 16px;" onclick="actualizarauditoria()">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-body text-center">
                ...
                <br><br>
                <p style="font-size: 16px;"> Actualizando Auditoría... </p>
            </div>
        </div>
    </div>
</div>
...
<script src="{{asset('assets/administrador/js/auditoria.js')}}"></script>
...
<script>
  ...
  const nameInterfaz = "Auditoria Interna";
  var isAuditoria= true;
</script>
@endsection