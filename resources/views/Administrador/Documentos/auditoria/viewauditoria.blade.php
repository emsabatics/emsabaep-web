...
@section('title-page')
Admin | AUDITORÍA {{getNameInstitucion()}}
@endsection
...
<section class="content">
  <div class="container-fluid">
          ...
          <div class="col-12">
              <div class="card">
                  <div class="card-header">
                      <h3 class="card-title p-2"><i class="fas fa-file-contract mr-3"></i> AUDITORÍA</h3>
      ...
      <div class="row">
        <div class="col-3"></div>
        @foreach ($fileauditoria as $item)
        <div class="col-6">
          <div class="card card-default">
            <div class="card-header">
              <h3 class="card-title">AUDITORIA {{$item->nombre}}</h3>
            </div>
            <div class="card-body">
              <div class="row">
                <div class="col-12">
                  <div class="container-iframe">
                    <object data="/doc-auditoria/{{$item->archivo}}" type="application/pdf" width="600" height="800"></object>
                  </div>
                </div>
              </div>
            </div>
