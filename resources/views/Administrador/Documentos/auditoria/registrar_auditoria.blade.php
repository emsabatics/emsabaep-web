          ...
          <div class="col-12">
              <div class="card card-default">
                  <div class="card-header">
                      <h3 class="card-title">Registrar Auditoría</h3>
                  ...
                  <div class="card-body">
                      <form id="formAuditoria" action="" method="POST" enctype="multipart/form-data">
                          <div class="row">
                              <div class="col-6">
                                  <div class="form-group">
                                    <label>Año:</label>
                                    <select class="form-control select2" id="selYearAuditoria" name="selYearAuditoria">
                          ...
                          <div class="row">
                              <div class="col-lg-12 mt-4 d-flex justify-content-end">
                                <button type="button" class="btn btn-primary saveauditoria" style="font-size: 16px;" onclick="guardarAuditoria()">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-body text-center">
                ...
                <br><br>
                <p style="font-size: 16px;"> Registrando Auditoria... </p>
            </div>
        </div>
    </div>
</div>
