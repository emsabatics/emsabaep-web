...
<section class="content">
  <div class="container-fluid">
          ...
          <div class="col-12">
              <div class="card">
                  <div class="card-header">
                      <h3 class="card-title p-2"><i class="fas fa-file-contract mr-3"></i> Vista Documentación Remisión de Intereses</h3>
      ...
      <div class="row">
        <div class="col-2"></div>
        @foreach ($filedocremision as $item)
        <div class="col-8">
              ...
              <div class="row">
                <div class="col-12">
                  <div class="container-iframe" style="overflow-x: auto;">
                    <object data="/doc-remision/{{$item->archivo}}" type="application/pdf" width="800" height="800"></object>
                  </div>
                </div>
              </div>
            </div>
