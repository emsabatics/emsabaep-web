...
@section('title-page')
Admin | Remisión de Intereses {{getNameInstitucion()}}
@endsection
...
<div class="row mb-2">
  <div class="col-sm-12">
    <h1>Actualizar Remisión de Interés</h1>
  </div>
</div>
@endsection
          ...
          <div class="col-12">
              <div class="card card-default">
                  <div class="card-header">
                      <h3 class="card-title">Actualizar Documentación Remisión de Interés</h3>
                  ...
                  <div class="card-body">
                      <form id="formdocadministrativoe" action="" method="POST" enctype="multipart/form-data">
                        @foreach ($filedocadmin as $p)
                          <div class="row">
                              <div class="col-6">
                                <div class="form-group noevent">
                                  <input type="hidden" name="iddocremisioni" id="iddocremisioni" value="{{$p->id}}">
                                  <label>Año:</label>
                                  <select class="form-control select2" id="selYearEditRemisionI" name="selYearEditRemisionI">
                              ...
                              <div class="col-6">
                                <div class="card-list grid-card-list" id="cardListDocAdmin">
                                ...
                                <div class="form-group mb-3 noshow" id="divfiledocadmin">
                          ...
                          <div class="row">
                            <div class="col-lg-6 col-12 mt-4 d-flex justify-content-start">
                              <button type="button" class="btn btn-danger deletedocadmin" style="font-size: 16px;" onclick="eliminarpermremision()">
                                <i class="fas fa-trash mr-2"></i>
                                Eliminar Permanentemente
                              </button>
                            </div>
                            <div class="col-lg-6 col-12 mt-4 d-flex justify-content-end">
                              <button type="button" class="btn btn-primary updatedocadmin" style="font-size: 16px;" onclick="actualizardocremision()">
