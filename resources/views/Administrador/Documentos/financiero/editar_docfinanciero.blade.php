...
<div class="row mb-2">
  <div class="col-sm-12">
    <h1>Actualizar Doc. Financiera</h1>
  </div>
</div>
@endsection
          ...
          <div class="col-12">
              <div class="card card-default">
                  <div class="card-header">
                      <h3 class="card-title">Actualizar Documentación Financiera</h3>
                  ...
                  <div class="card-body">
                      <form id="formdocfincancieroe" action="" method="POST" enctype="multipart/form-data">
                        @foreach ($filedocfin as $p)
                          <div class="row">
                              <div class="col-6">
                                <div class="form-group noevent">
                                  <input type="hidden" name="iddocfinanciero" id="iddocfinanciero" value="{{$p->id}}">
                                  <label>Año:</label>
                                  <select class="form-control select2" id="selYearEditDocFin" name="selYearEditDocFin">
                              ...
                              <div class="col-6">
                                <div class="card-list grid-card-list" id="cardListDocFin">
                                ...
                                <div class="form-group mb-3 noshow" id="divfiledocfin">
                          ...
                          <div class="row">
                            <div class="col-lg-6 col-12 mt-4 d-flex justify-content-start">
                              <button type="button" class="btn btn-danger deletedocfin" style="font-size: 16px;" onclick="eliminarpermdocfin()">
                                <i class="fas fa-trash mr-2"></i>
                                Eliminar Permanentemente
                              </button>
                            </div>
                            <div class="col-lg-6 col-12 mt-4 d-flex justify-content-end">
                              <button type="button" class="btn btn-primary updatedocfin" style="font-size: 16px;" onclick="actualizardocfin()">
