...
<div class="row">
  <div class="col-12">
      <div class="card">
          ...
          <div class="card-body">
            <form id="formEditTransparencia" method="POST" enctype="multipart/form-data">
              <div class="row">
                <div class="col-lg-12 mt-2">
                  <textarea id="summernote">
                  @foreach ($dataTexto as $item)
                    {{$item->descripcion}}
                  @endforeach
                  </textarea>
                </div>
              ...
              <div class="row">
                <div class="col-lg-12 mt-4 d-flex justify-content-end">
                  <button type="button" class="btn btn-primary button-update-transparencia" style="font-size: 16px;" onclick="actualizarTransparencia()">
