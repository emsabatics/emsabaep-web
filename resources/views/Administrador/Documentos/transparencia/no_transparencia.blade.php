...
<div class="row mb-2">
  <div class="col-sm-12">
    <h1>TRANSPARENCIA de la Institución</h1>
  </div>
</div>
@endsection
      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <h3 class="card-title"><i class="far fa-file-word mr-3" aria-hidden="true"></i> TRANSPARENCIA de la Institución</h3>
          ...
          <div class="card-body">
            ...
            <div class="row nonews" id="divImgTransparencia"></div>
          </div>
        </div>
      </div>
    </div>
...
<script>
  var inforTransparencia = {{ Illuminate\Support\Js::from($transparencia) }};

  setTimeout(() => {
    cargar_transparencia(inforTransparencia);
  }, 500);

  // Summernote
  //$('#divTransparencia').summernote();
</script>
@endsection