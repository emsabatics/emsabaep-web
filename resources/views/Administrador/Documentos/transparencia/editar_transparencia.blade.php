...
@section('title-page')
Admin | Ley de Transparencia {{getNameInstitucion()}}
@endsection
...
<div class="row mb-2">
  <div class="col-sm-12">
    <h1>Actualizar Ley de Transparencia</h1>
  </div>
</div>
@endsection
          ...
          <div class="col-12">
              <div class="card card-default">
                  <div class="card-header">
                      <h3 class="card-title">Actualizar Ley de Transparencia</h3>
                  ...
                  <div class="card-body">
                    <form id="formTransparenciaE" action="" method="POST" enctype="multipart/form-data">
                      @foreach ($transparencia as $p)
                        <div class="row">
                          <div class="col-md-6" id="divfiletext">
                            <input type="hidden" name="idfilet" id="idfilet" value="{{$p->id}}">
                            <div class="form-group">
                              <label for="inputENameTransparencia">Nombre del Documento: <span class="spanlabel">70 caracteres máximo</span></label>
                              <textarea class="form-control text-justify" id="inputENameTransparencia" name="inputENameTransparencia" placeholder="Ingrese un nombre"
                                  maxlength="70">{{$p->nombre_archivo}}</textarea>
                            </div>
                            <div class="form-group mr-3 mt-3">
                              <label for="inputAliasFileTranspE">Alias del Documento: <span class="spanlabel">70 caracteres máximo</span></label>
                              <div class="input-group mb-3">
                                <button class="btn btn-outline-primary" type="button" onclick="generarAliasE()">Generar</button>
                                <textarea id="inputAliasFileTranspE" name="inputAliasFileTranspE" class="form-control text-justify noevent" placeholder="Ingrese un alias" 
                                  aria-label="Example" aria-describedby="button-addon1" maxlength="70">{{substr($p->archivo, 0, -4);}}</textarea>
                              </div>
                            </div>
                            <div class="card-list grid-card-list" id="cardListTransp">
                          ...
                          <div class="col-md-6 noshow" id="divfiletransp">
                        ...
                        <div class="row">
                          <div class="col-lg-12 mt-4 d-flex justify-content-end">
                            <button type="button" class="btn btn-primary saveuptransp" style="font-size: 16px;" onclick="actualizarTransparencia()">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-body text-center">
                ...
                <br><br>
                <p style="font-size: 16px;"> Registrando Ley de Transparencia... </p>
            </div>
        </div>
    </div>
</div>
