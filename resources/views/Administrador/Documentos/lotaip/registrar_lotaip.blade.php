          ...
          <div class="col-12">
              <div class="card card-default">
                  <div class="card-header">
                      <h3 class="card-title">Registrar LOTAIP</h3>
                      ...
                      <form id="formLOTAIP" action="" method="POST" enctype="multipart/form-data">
                          <div class="row">
                              <div class="col-6">
                                  ...
                                  <div class="form-group">
                                    <label>Literal:</label>
                                    <select class="form-control select2" id="selItemLotaip" name="selItemLotaip">
                                      <optgroup label="Seleccione una Opción">
                                        <option value="0">-Seleccione una Opción-</option>
                          ...
                          <div class="row">
                              <div class="col-lg-12 mt-4 d-flex justify-content-end">
                                <button type="button" class="btn btn-primary savelotaip" style="font-size: 16px;" onclick="guardarLotaip()">
