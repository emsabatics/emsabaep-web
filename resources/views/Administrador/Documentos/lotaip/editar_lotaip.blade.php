      ...
      <div class="row">
          <div class="col-12">
              <div class="card card-default">
                  ...
                  <div class="card-body">
                      <form id="formLOTAIP_E" action="" method="POST" enctype="multipart/form-data">
                        @foreach ($filelotaip as $p)
                          <div class="row">
                              <div class="col-6">
                                  <div class="form-group noevent">
                                    <input type="hidden" name="idlotaip" id="idlotaip" value="{{$p->id}}">
                                    <label>Año:</label>
                                    <select class="form-control select2" id="selYearELotaip" name="selYearELotaip">
                                  ...
                                  <div class="form-group noevent">
                                    <label>Literal:</label>
                                    <select class="form-control select2" id="selItemELotaip" name="selItemELotaip">
                                      <optgroup label="Seleccione una Opción">
                                        <option value="0">-Seleccione una Opción-</option>
                              ...
                              <div class="col-6">
                                <div class="card-list grid-card-list" id="cardListLotaip">
                                ...
                                <div class="form-group mb-3 noshow" id="divfilelo">
                          ...
                          <div class="row">
                              <div class="col-lg-12 mt-4 d-flex justify-content-end">
                                <button type="button" class="btn btn-primary savelotaip" style="font-size: 16px;" onclick="actualizarLotaip()">
