                    ...
                    <div class="card-header">
                        <div class="cardsRowTitle">
                            <div class="cardsection">
                              <h3 class="card-title p-2"><i class="fas fa-list-ul mr-3"></i> Opciones LOTAIP</h3>
                            </div>
                            <div class="cardsection">
                              <button type="button" class="btn btn-primary btn-block" onclick="openmodalAddOptLotaip()"><i
                                class="far fa-plus-square mr-2"></i> Registrar</button>
                            </div>
                        </div>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body table-responsive p-4" id="divTablaOptLotaip">
                      <table class="table table-hover text-nowrap table-head-fixed" id="tablaListadoOptLotaip">
                        <thead>
                        ...
                        <tbody>
                          @if (count($optlotaip) > 0)
                          @foreach ($optlotaip as $item)
                              <tr id="Tr{{$loop->index}}">
                                ...
                                <td style="text-align: center;">
                                  <div class="dropdown show">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                      <a class="dropdown-item" href="javascript:void(0)" onclick="editarOptLiteral({{$item->id}})">Editar</a>
                                      @if ($item->estado=='1')
                                      <a class="dropdown-item" href="javascript:void(0)" onclick="eliminarOptLiteral({{$item->id}}, {{$loop->index}})">Inactivar</a>
                                      @else
                                      <a class="dropdown-item" href="javascript:void(0)" onclick="activarOptLiteral({{$item->id}}, {{$loop->index}})">Activar</a>
                                      @endif
                                    </div>
                                  </div>
                                </td>
...
<div class="modal fade" id="modalAggOpcionLot" tabindex="-1" role="dialog" aria-labelledby="modalArchivosTitle"
aria-hidden="true" data-backdrop="static" data-keyboard="false" data-bs-focus="false">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Agregar Opción LOTAIP</h4>
            ...
            <div class="modal-footer">
                ...
                <button id="btnsaveoptlo" type="button" class="btn btn-primary mb-2" onclick="guardarRegistroOptLot()">Guardar</button>
            </div>
        </div>
        <!-- /.modal-content -->
    </div>
...
<div class="modal fade" id="modalEditOpcionLot" tabindex="-1" role="dialog" aria-labelledby="modalArchivosTitle"
aria-hidden="true" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title">Editar Opción LOTAIP</h4>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <div class="row">
          <div class="col-lg-12">
            <input type="hidden" name="idopcionlotaip" id="idopcionlotaip">
            <div class="form-group mb-3">
              <label for="inputDescpEOpt">Descripción:</label>
              <input type="text" id="inputDescpEOpt" class="form-control" placeholder="Descripción" autocomplete="off">
            </div>
          </div>
        </div>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary mb-2" data-dismiss="modal">Cerrar</button>
        <button id="btnupoptlo" type="button" class="btn btn-primary mb-2" onclick="actualizarRegistroOptLo()">Actualizar</button>
      </div>
    </div>
    <!-- /.modal-content -->
  </div>
