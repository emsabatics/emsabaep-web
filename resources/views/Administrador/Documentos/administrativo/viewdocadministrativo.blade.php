          ...
          <div class="col-12">
              <div class="card">
                  <div class="card-header">
                      <h3 class="card-title p-2"><i class="fas fa-file-contract mr-3"></i> Vista Documentación Administrativa</h3>
              ...
              <div class="row">
                <div class="col-12">
                  <div class="container-iframe" style="overflow-x: auto;">
                    <object data="/doc-administrativo/{{$item->archivo}}" type="application/pdf" width="800" height="800"></object>
                  </div>
                </div>
              </div>
            </div>
