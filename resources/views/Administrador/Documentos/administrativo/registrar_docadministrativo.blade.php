...
@section('title-page')
Admin | Doc Administrativa {{getNameInstitucion()}}A
@endsection
          ...
          <div class="col-12">
              <div class="card card-default">
                  <div class="card-header">
                      <h3 class="card-title">Registrar Documentación Administrativa</h3>
                      ...
                      <form id="formDocAdmin" action="" method="POST" enctype="multipart/form-data">
                          <div class="row">
                            <div class="col-md-6">
                              <div class="form-group">
                                <label>Año:</label>
                                <select class="form-control select2" id="selYearDocAdmin" name="selYearDocAdmin">
                              ...
                              <div class="form-group">
                                <label for="inputNameDocAdmin">Nombre del Documento: <span class="spanlabel">250 caracteres máximo</span></label>
                                <textarea class="form-control text-justify" id="inputNameDocAdmin" name="inputNameDocAdmin" placeholder="Ingrese un nombre"
                                  maxlength="250"></textarea>
                              </div>
                              <div class="form-group mr-3 mt-3">
                                <label for="inputAliasFileDocAdmin">Alias del Documento: <span class="spanlabel">250 caracteres máximo</span></label>
                                <div class="input-group mb-3">
                                  <button class="btn btn-outline-primary" type="button" onclick="generarAlias()">Generar</button>
                                  <textarea id="inputAliasFileDocAdmin" name="inputAliasFileDocAdmin" class="form-control text-justify noevent" placeholder="Ingrese un alias" aria-label="Example" aria-describedby="button-addon1" maxlength="250"></textarea>
                                </div>
                              </div>
                            </div>
                            <div class="col-md-6">
                          ...
                          <div class="row">
                              <div class="col-lg-12 mt-4 d-flex justify-content-end">
                                <button type="button" class="btn btn-primary savedocadmin" style="font-size: 16px;" onclick="guardarDocAdmin()">
...
<script>
  ...
  const nameInterfaz = "Doc. Administrativa";
