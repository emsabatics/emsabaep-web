...
<div class="row mb-2">
  <div class="col-sm-12">
    <h1>Actualizar Doc. Administrativa</h1>
  </div>
</div>
@endsection
          ...
          <div class="col-12">
              <div class="card card-default">
                  <div class="card-header">
                      <h3 class="card-title">Actualizar Documentación Administrativa</h3>
                        ...
                        @foreach ($filedocadmin as $p)
                          <div class="row">
                              <div class="col-6">
                                <div class="form-group noevent">
                                  <input type="hidden" name="iddocadministrativo" id="iddocadministrativo" value="{{$p->id}}">
                                  <label>Año:</label>
                                  <select class="form-control select2" id="selYearEditDocAdmin" name="selYearEditDocAdmin">
                          ...
                          <div class="row">
                            <div class="col-lg-6 col-12 mt-4 d-flex justify-content-start">
                              <button type="button" class="btn btn-danger deletedocadmin" style="font-size: 16px;" onclick="eliminarpermdocadmin()">
                                <i class="fas fa-trash mr-2"></i>
                                Eliminar Permanentemente
                              </button>
                            </div>
                            <div class="col-lg-6 col-12 mt-4 d-flex justify-content-end">
                              <button type="button" class="btn btn-primary updatedocadmin" style="font-size: 16px;" onclick="actualizardocadmin()">
