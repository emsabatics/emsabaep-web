...
<section class="content">
  <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-3"></div>
        @foreach ($filept as $item)
        <div class="col-6">
          <div class="card card-default">
            <div class="card-header">
              <div class="card-title text-justify">{{$item->observacion}}</div>
            </div>
            <div class="card-body">
              <div class="row">
                <div class="col-12">
                  @if ($item->tipo_file=='pdf')
                  <div class="container-iframe">
                    <object data="/doc-pliego-tarifario/{{$item->archivo}}" type="application/pdf" width="600" height="800"></object>
                  </div>
                  @endif
                  @if ($item->tipo_file=='image')
                    <div class="viewImgPliegoT">
                      <img src="/doc-pliego-tarifario/{{$item->archivo}}" alt="Pliego Tarifario">
                    </div>
                  @endif
                </div>
              </div>
