          ...
          <div class="col-12">
              <div class="card card-default">
                  <div class="card-header">
                      <h3 class="card-title">Editar Pliego Tarifario</h3>
                  ...
                  <div class="card-body">
                      <form id="formE_Pliego" action="" method="POST" enctype="multipart/form-data">
                          @foreach ($filepliego as $p)
                          <div class="row">
                            <div class="col-md-2"></div>
                            <div class="col-8">
                              <div class="form-group mb-3">
                                <input type="hidden" name="idpliego" id="idpliego" value="{{$p->id}}">
                                <input type="hidden" name="tipofpliego" id="tipofpliego" value="{{$p->tipo_file}}">
                                <label for="inputEObsr">Descripción:</label>
                                <textarea class="form-control text-justify" id="inputEObsr" name="inputEObsr"
                                    placeholder="Descripción" rows="4" cols="5">{{$p->observacion}}</textarea>
                              </div>
                              <div class="form-group">
                                <label for="inputAliasFileE">Alias del Documento: <span class="spanlabel">70 caracteres máximo</span></label>
                                <textarea id="inputAliasFileE" name="inputAliasFileE" class="form-control text-justify" placeholder="Ingrese un alias" aria-label="Example"
                                  aria-describedby="button-addon1" maxlength="70">{{substr($p->archivo, 0, -4);}}</textarea>
                              </div>
                            </div>
                            <div class="col-md-2"></div>
                          </div>
                          <div class="row">
                            <div class="col-md-2"></div>
                            <div class="col-lg-8">
                              <div class="card-list grid-card-list" id="cardListPliego">
                                <div class='item-list grid-item-list' id='divpics'>
                                  <div style='grid-row: 1/2;'>
                                    <div class='avatar' style="text-align: center;height: 78px;">
                                      ...
                                      @endif
                                      @if ($p->tipo_file=="image")
                                      <img src='/assets/administrador/img/icons/icon-img-color.svg' alt='File' class='avatar-img' style="width: 78px;height: 78px;">
                                      @endif
                                    </div>
                                  </div>
                                  <div style='grid-row: 1/2;'>
                              ...
                              <div class="form-group mb-3 noshow" id="divfilepliego">
                                <span class="spanlabel m-4">Seleccione solo un archivo</span>
                                <div class="container">
                                  <input type="file" name="fileEdit[]" id="fileEdit" accept="application/pdf, image/*" onchange="previewEdit()" multiple>
                                  <label for="fileEdit">
                          ...
                          <div class="row">
                              <div class="col-lg-12 mt-4 d-flex justify-content-end">
                                <button type="button" class="btn btn-primary" style="font-size: 16px;" onclick="actualizarpliego()">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-body text-center">
                ...
                <br><br>
                <p style="font-size: 16px;"> Actualizando Pliego... </p>
            </div>
        </div>
    </div>
</div>
