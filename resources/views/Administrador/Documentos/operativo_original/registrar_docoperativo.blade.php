                      ...
                      <form id="formDocOper" action="" method="POST" enctype="multipart/form-data">
                          <div class="row">
                            <div class="col-md-6">
                              <div class="form-group">
                                <label>Año:</label>
                                <select class="form-control select2" id="selYearDocOper" name="selYearDocOper">
                              ...
                              <div class="form-group">
                                <label for="inputNameDocOper">Nombre del Documento: <span class="spanlabel">250 caracteres máximo</span></label>
                                <textarea class="form-control text-justify" id="inputNameDocOper" name="inputNameDocOper" placeholder="Ingrese un nombre"
                                  maxlength="250"></textarea>
                              </div>
                              <div class="form-group mr-3 mt-3">
                                <label for="inputAliasFileDocOper">Alias del Documento: <span class="spanlabel">250 caracteres máximo</span></label>
                                <div class="input-group mb-3">
                                  <button class="btn btn-outline-primary" type="button" onclick="generarAlias()">Generar</button>
                                  <textarea id="inputAliasFileDocOper" name="inputAliasFileDocOper" class="form-control text-justify noevent" placeholder="Ingrese un alias" aria-label="Example" aria-describedby="button-addon1" maxlength="250"></textarea>
                                </div>
                              </div>
                            </div>
                            <div class="col-md-6">
                          ...
                          <div class="row">
                              <div class="col-lg-12 mt-4 d-flex justify-content-end">
                                <button type="button" class="btn btn-primary savedocoper" style="font-size: 16px;" onclick="guardarDocOper()">
