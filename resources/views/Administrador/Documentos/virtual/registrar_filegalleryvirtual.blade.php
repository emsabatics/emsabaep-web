                      ...
                      <form id="formDocBiVirtual" action="" method="POST" enctype="multipart/form-data">
                          ...
                          <div class="row">
                            <div class="col-lg-12">
                              <div class="form-group mb-3">
                                <div class="container">
                                  <input type="file" name="file[]" id="file" accept="image/*" onchange="previewFilebv()" multiple>
                                  <label for="file">
                          ...
                          <div class="row">
                              <div class="col-lg-12 mt-4 d-flex justify-content-end">
                                <button type="button" class="btn btn-primary savedocvirtual" style="font-size: 16px;" onclick="guardarImagenesDocvi()">
...
<script src="{{asset('assets/administrador/js/drag-drop-files-bv.js')}}"></script>
