      ...
      <div class="row">
          <div class="col-12">
              <div class="card card-default">
                  ...
                  <div class="card-body">
                      <form id="formDocBiVirtual" action="" method="POST" enctype="multipart/form-data">
                          <div class="row">
                            <div class="col-md-6">
                              ...
                              @endif
                              <div class="form-group">
                                <label for="inputNameDocBiVir">Nombre del Documento: <span class="spanlabel">250 caracteres máximo</span></label>
                              ...
                              <div class="form-group mr-3 mt-3">
                                <label for="inputAliasFileDocBiVir">Alias del Documento: <span class="spanlabel">250 caracteres máximo</span></label>
                                <div class="input-group mb-3">
                                  <button class="btn btn-outline-primary" type="button" onclick="generarAlias()">Generar</button>
                                  <textarea id="inputAliasFileDocBiVir" name="inputAliasFileDocBiVir" class="form-control text-justify noevent" placeholder="Ingrese un alias" aria-label="Example" aria-describedby="button-addon1" maxlength="250"></textarea>
                                </div>
                              </div>
                              <div class="form-group mt-3">
                                <label for="inputDescpDocBiVir">Descipción del Documento: <span class="spanlabel">500 caracteres máximo</span></label>
                          ...
                          <div class="row">
                              <div class="col-lg-12 mt-4 d-flex justify-content-end">
                                <button type="button" class="btn btn-primary savedocvirtual" style="font-size: 16px;" onclick="guardarDocVirtual()">
