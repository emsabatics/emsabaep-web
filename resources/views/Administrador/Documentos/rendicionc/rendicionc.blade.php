                        ...
                        <div class="row">
                          <div class="col-12">
                            ...
                            <div class="card card-primary">
                              <div class="card-header">
                                <h3 class="card-title">RENDICIÓN DE CUENTAS {{$i['anio']}} VIDEO</h3>
                                  ...
                                  <tbody>
                                    ...
                                    <tr id="Tr{{$loop->index}}-{{$i['anio']}}-video">
                                      ...
                                      <td style="display: flex;">
                                        ...
                                        @if ($f['estado']=='1')
                                        <button type="button" class="btn btn-secondary btn-sm mr-3 btntable" title="Inactivar" onclick="inactivarrendicionc({{$f['id']}}, {{$loop->index}}, {{$i['anio']}}, 'video')">
                                          <i class="fas fa-eye-slash"></i>
                                        </button>
                                        @else
                                        <button type="button" class="btn btn-secondary btn-sm mr-3 btntable" title="Activar" onclick="activarrendicionc({{$f['id']}}, {{$loop->index}}, {{$i['anio']}}, 'video')">
                            ...
                            <div class="card card-info">
                              <div class="card-header">
                                <h3 class="card-title">MEDIOS DE VERIFICACIÓN {{$i['anio']}}</h3>
                                <div class="card-tools">
                                  <button type="button" class="btn btn-tool" data-card-widget="collapse" title="Collapse">
                                    <i class="fas fa-minus"></i>
                                  </button>
                                ...
                                <table class="table table-head-fixed text-nowrap" id="table-{{$i['anio']}}-medio">
                                  ...
                                  <tbody>
                                    ...
                                    <tr id="Tr{{$loop->index}}-{{$i['anio']}}-medio">
                                      ...
                                      <td class="celdaAsignado">{{$mv['titulo']}}</td>
                                      <td>
                                        @if ($mv['estado']=='0')
                                        <span class="badge badge-secondary">No Visible</span>
                                        @else
                                      ...
                                      <td style="display: flex;">
                                        <button type="button" class="btn btn-primary btn-sm mr-3 btntable" title="Ver" onclick="viewopenrendicionc({{$mv['id']}})">
                                          <i class="fas fa-folder"></i>
                                        </button>
                                        <button type="button" class="btn btn-info btn-sm mr-3 btntable" title="Actualizar" onclick="interfaceupdaterendicionc({{$mv['id']}})">
                                          <i class="far fa-edit"></i>
                                        </button>
                                        @if ($mv['estado']=='1')
                                        <button type="button" class="btn btn-secondary btn-sm mr-3 btntable" title="Inactivar" onclick="inactivarrendicionc({{$mv['id']}}, {{$loop->index}}, {{$i['anio']}}, 'medio')">
                                          <i class="fas fa-eye-slash"></i>
                                        </button>
                                        @else
                                        <button type="button" class="btn btn-secondary btn-sm mr-3 btntable" title="Activar" onclick="activarrendicionc({{$mv['id']}}, {{$loop->index}}, {{$i['anio']}}, 'medio')">
                                          <i class="fas fa-eye"></i>
                                        </button>
                                        @endif
