...
@section('title-page')
Admin | Rendicón de Cuentas {{getNameInstitucion()}}
@endsection
...
<div class="row mb-2">
  <div class="col-sm-12">
    <h1>Actualizar Rendicón de Cuentas</h1>
  </div>
</div>
@endsection
          ...
          <div class="col-12">
              <div class="card card-default">
                  <div class="card-header">
                      <h3 class="card-title">Actualizar Rendicón de Cuentas</h3>
                  ...
                  <div class="card-body">
                      <form id="formrendicionc_e" action="" method="POST" enctype="multipart/form-data">
                        @foreach ($filerendicionc as $p)
                          <div class="row">
                              <div class="col-6">
                                <div class="form-group noevent">
                                  <input type="hidden" name="idrendicionc" id="idrendicionc" value="{{$p->id_rendicion_cuenta}}">
                                  <input type="hidden" name="id_filerc" id="id_filerc" value="{{$p->id}}">
                                  <label>Año:</label>
                                  <select class="form-control select2" id="selYearERendicionc" name="selYearERendicionc">
                                ...
                                <div class="form-group noevent">
                                  <label>Tipo:</label>
                                  <select class="form-control select2" id="selETipo" name="selETipo">
                                    <optgroup label="Seleccione una Opción">
                                      <option value="0">-Seleccione una Opción-</option>
                                      @if ($p->tipo == "video")
                                      <option value="video" selected>Vídeo</option>
                                      <option value="medio">Medio de Verificación</option>
                                      @elseif ($p->tipo == "medio")
                                      <option value="video">Vídeo</option>
                                      <option value="medio" selected>Medio de Verificación</option>
                                      @else
                                      <option value="video">Vídeo</option>
                                      <option value="medio">Medio de Verificación</option>
                                      @endif
                              ...
                              <div class="col-6">
                                <div class="card-list grid-card-list" id="cardListRendicionc">
                                    ...
                                    <div style='grid-row: 1/2;'>
                                      <div class='avatar' style="text-align: center;height: 78px;">
                                        ...
                                        <img src='/assets/administrador/img/icons/icon-pdf-color.svg' alt='File' class='avatar-img' style="width: 78px;height: 78px;">
                                         @else
                                        <img src='/assets/administrador/img/icons/icon-video-color.svg' alt='File' class='avatar-img' style="width: 78px;height: 78px;">
                                         @endif
                                      </div>
                                    </div>
                                    <div style='grid-row: 1/2;'>
                                ...
                                <div class="form-group mb-3 noshow" id="divfilerc">
                                  <span class="spanlabel m-4">Seleccione solo un archivo</span>
                                    <div class="container">
                                      <input type="file" name="fileEdit[]" id="fileEdit" accept="application/pdf, video/mp4" onchange="previewEdit()" multiple>
                                      <label for="fileEdit">
                          ...
                          <div class="row">
                              <div class="col-lg-12 mt-4 d-flex justify-content-end">
                                <button type="button" class="btn btn-primary saverendicionc" style="font-size: 16px;" onclick="actualizarrendicionc()">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-body text-center">
                ...
                <br><br>
                <p style="font-size: 16px;"> Actualizando Rendicón de Cuentas... </p>
            </div>
        </div>
    </div>
</div>
