...
<div class="row mb-2">
  <div class="col-sm-12">
    <h1>Registro Rendición de Cuentas</h1>
  </div>
</div>
@endsection
          ...
          <div class="col-12">
              <div class="card card-default">
                  <div class="card-header">
                      <h3 class="card-title">Registrar Rendición de Cuentas</h3>
                  ...
                  <div class="card-body">
                      <form id="formRendicionc" action="" method="POST" enctype="multipart/form-data">
                          <div class="row">
                              <div class="col-6">
                                  <div class="form-group">
                                    <label>Año:</label>
                                    <select class="form-control select2" id="selYearRendicionc" name="selYearRendicionc">
                                  ...
                                  <div class="form-group" id="div-medio-title-doc">
                                    <label for="inputDocTitle">Título del Documento: <span class="spanlabel"></span></label>
                                    <textarea class="form-control text-justify" id="inputDocTitle" name="inputDocTitle" placeholder="Ingrese un título"
                              ...
                              <div class="col-6">
                                <div class="form-group mb-3">
                                  <span class="spanlabel m-4" id="span-info-file">Seleccione solo un archivo</span>
                                  <div class="container">
                                    <input type="file" name="file[]" id="file" accept="application/pdf, video/mp4" onchange="preview()" multiple>
                                    <label for="file">
                          ...
                          <div class="row">
                              <div class="col-lg-12 mt-4 d-flex justify-content-end">
                                <button type="button" class="btn btn-primary saverendicionc" style="font-size: 16px;" onclick="guardarRendicionc()">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-body text-center">
                ...
                <br><br>
                <p style="font-size: 16px;"> Registrando Rendición de Cuentas... </p>
            </div>
        </div>
    </div>
</div>
