...
<div class="row mb-2">
  <div class="col-sm-12">
    <h1>Actualizar Estatutos - Reglamentos y Reformas</h1>
  </div>
</div>
@endsection
          ...
          <div class="col-12">
              <div class="card card-default">
                  <div class="card-header">
                      <h3 class="card-title">Actualizar Estatutos - Reglamentos y Reformas</h3>
                  ...
                  <div class="card-body">
                    <form id="formLEY_e" action="" method="POST" enctype="multipart/form-data">
                      @foreach ($reglamento as $p)
                        <div class="row">
                          ...
                          <div class="col-md-6 noshow" id="divfileley">
                        ...
                        <div class="row">
                          <div class="col-lg-12 mt-4 d-flex justify-content-end">
                            <button type="button" class="btn btn-primary saveley" style="font-size: 16px;" onclick="actualizarLey()">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-body text-center">
                ...
                <br><br>
                <p style="font-size: 16px;"> Registrando Reglamento... </p>
            </div>
        </div>
    </div>
</div>
