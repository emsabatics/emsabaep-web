...
<div class="row mb-2">
  <div class="col-sm-12">
    <h1>Registro Estatutos - Reglamentos y Reformas</h1>
  </div>
</div>
@endsection
          ...
          <div class="col-12">
              <div class="card card-default">
                  <div class="card-header">
                      <h3 class="card-title">Registrar Estatutos - Reglamentos y Reformas</h3>
                  ...
                  <div class="card-body">
                      <form id="formLEY" action="" method="POST" enctype="multipart/form-data">
                          <div class="row">
                            <div class="col-md-6">
                          ...
                          <div class="row">
                              <div class="col-lg-12 mt-4 d-flex justify-content-end">
                                <button type="button" class="btn btn-primary saveley" style="font-size: 16px;" onclick="guardarLey()">
