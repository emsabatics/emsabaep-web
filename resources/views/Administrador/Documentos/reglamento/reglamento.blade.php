...
@section('title-page')
Admin | REGLAMENTOS {{getNameInstitucion()}}
@endsection
...
<div class="row mb-2">
  <div class="col-sm-12">
    <h1>Estatutos - Reglamentos y Reformas</h1>
  </div>
</div>
@endsection
          ...
          <div class="col-12">
              <div class="card">
                  <div class="card-header">
                      <h3 class="card-title p-2"><i class="fas fa-file-contract mr-3"></i> Estatutos - Reglamentos y Reformas</h3>
                      <div class="card-tools" id="card-tools">
                          <button type="button" class="btn btn-primary btn-block" onclick="urlregistrarley()"><i
                      ...
                      <tbody>
                        ...
                        <tr id="Tr{{$loop->index}}">
                          ...
                          <td class="project-actions text-right">
                            <a class="btn btn-primary btn-sm mt-2 mr-3" href="javascript:void(0)" onclick="viewopenLey({{$item->id}})">
                              <i class="fas fa-folder mr-3"></i>
                              Ver
                            </a>
                            <a class="btn btn-info btn-sm mt-2 mr-3" href="javascript:void(0)" onclick="interfaceupdateLey({{$item->id}})">
                              <i class="far fa-edit mr-3"></i>
                              Actualizar
                            </a>
                            @if ($item->estado=='1')
                            <a class="btn btn-secondary btn-sm mt-2 mr-3" href="javascript:void(0)" onclick="inactivarLey({{$item->id}}, {{$loop->index}})">
                              <i class="fas fa-eye-slash mr-3"></i>
                              Inactivar
                            </a>
                            @else
                            <a class="btn btn-secondary btn-sm mt-2 mr-3" href="javascript:void(0)" onclick="activarLey({{$item->id}}, {{$loop->index}})">
