...
<section class="content">
  <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-3"></div>
        @foreach ($filer as $item)
        <div class="col-6">
          <div class="card card-default">
            <div class="card-header">
              <h3 class="card-title">{{$item->nombre_archivo}}</h3>
            </div>
            <div class="card-body">
              <div class="row">
                <div class="col-12">
                  <div class="container-iframe" style="height: 700px;overflow-x: auto;">
                    <object data="/doc-reglamentos/{{$item->archivo}}" type="application/pdf" width="600" height="800"></object>
                  </div>
                </div>
              </div>
            </div>
