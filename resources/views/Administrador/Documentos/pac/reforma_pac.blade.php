          ...
          <div class="col-12">
              <div class="card">
                  <div class="card-header">
                      <h3 class="card-title p-2"><i class="fas fa-file-contract mr-3"></i> REFORMAS PAC HISTÓRICO</h3>
                  ...
                  <!-- /.card-header -->
                  <div class="card-body table-responsive p-4" id="divRefPac">
                      ...
                      <tbody>
                        ...
                        <tr id="Tr{{$loop->index}}">
                          ...
                          <td class="project-actions text-right">
                            <a class="btn btn-primary btn-sm mt-2 mr-3" href="javascript:void(0)" onclick="viewopenRefPAC({{$item->id}})">
                              <i class="fas fa-folder mr-3"></i>
                              Ver
                            </a>
                            <a class="btn btn-info btn-sm mt-2 mr-3" href="javascript:void(0)" onclick="interfaceupdateRefPAC({{$item->id}})">
                              <i class="far fa-edit mr-3"></i>
                              Actualizar
                            </a>
                            @if ($item->estado=='1')
                            <a class="btn btn-secondary btn-sm mt-2 mr-3" href="javascript:void(0)" onclick="inactivarRefPAC({{$item->id}}, {{$loop->index}})">
                              <i class="fas fa-eye-slash mr-3"></i>
                              Inactivar
                            </a>
                            @else
                            <a class="btn btn-secondary btn-sm mt-2 mr-3" href="javascript:void(0)" onclick="activarRefPAC({{$item->id}}, {{$loop->index}})">
