          ...
          <div class="col-12">
              <div class="card card-default">
                  <div class="card-header">
                      <h3 class="card-title">Registrar PAC</h3>
                  ...
                  <div class="card-body">
                      <form id="formPAC" action="" method="POST" enctype="multipart/form-data">
                          <div class="row">
                              <div class="col-6">
                                  <div class="form-group">
                                    <label>Año:</label>
                                    <select class="form-control select2" id="selYearPac" name="selYearPac">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <textarea class="form-control text-justify noevent" id="inputAliasFile" name="inputAliasFile" placeholder="Ingrese un alias"
                                      maxlength="70"></textarea>
                                  </div>
                          ...
                          <div class="row" style="border-top: 2mm ridge #32a1ce;padding-top: 15px;">
                            ...
                            <div class="col-6">
                              <div class="form-group">
                                <label for="inputResolucion">Resolución Administrativa: <span class="spanlabel"></span></label>
                                <textarea class="form-control text-justify" id="inputResolucion" name="inputResolucion" placeholder="Ingrese un título"
                                  maxlength="70"></textarea>
                              </div>
                              <div class="form-group">
                                <label for="inputAliasFileRA">Alias del Documento: <span class="spanlabel">70 caracteres máximo</span></label>
                                <!--<textarea class="form-control text-justify" id="inputAliasFileRA" placeholder="Ingrese un alias"
                                  maxlength="70"></textarea>-->
                                <div class="input-group mb-3">
                                  <button class="btn btn-outline-primary" type="button" onclick="generarAlias()">Generar</button>
                                  <textarea id="inputAliasFileRA" name="inputAliasFileRA" class="form-control text-justify noevent" placeholder="Ingrese un alias" aria-label="Example" aria-describedby="button-addon1" maxlength="70"></textarea>
                                </div>
                              </div>
                            </div>
                            <div class="col-6">
                              <div class="form-group mb-3">
                                <span class="spanlabel m-4">Seleccione solo un archivo</span>
                                <div class="container">
                                  <input type="file" name="filera[]" id="filera" accept="application/pdf" onchange="previewopcional()" multiple>
                                  <label for="filera">
                                    <i class="fas fa-cloud-upload-alt mr-2"></i> Elija un archivo
                                  </label>
                                  <p id="num-of-files-ra">- Ningún archivo seleccionado -</p>
                                  <div id="imagesra"></div>
                                </div>
                              </div>
                            </div>
                          ...
                          <div class="row">
                              <div class="col-lg-12 mt-4 d-flex justify-content-end">
                                <button type="button" class="btn btn-primary" style="font-size: 16px;" onclick="guardarPac()">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-body text-center">
                ...
                <br><br>
                <p style="font-size: 16px;"> Registrando PAC... </p>
            </div>
        </div>
    </div>
</div>
