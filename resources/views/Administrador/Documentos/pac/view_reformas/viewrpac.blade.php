...
<section class="content">
  <div class="container-fluid">
          ...
          <div class="col-12">
              <div class="card">
                  <div class="card-header">
                      <h3 class="card-title p-2"><i class="fas fa-file-contract mr-3"></i> PAC REFORMADO</h3>
      ...
      <div class="row">
        @foreach ($filepac as $item)
        <div class="col-6">
          <div class="card card-default">
            <div class="card-header">
              <h3 class="card-title">PAC REFORMADO {{$item->nombre}}</h3>
            </div>
            <div class="card-body">
              <div class="row">
                <div class="col-12">
                  <div class="container-iframe">
                    <object data="/doc-pac/{{$item->archivo}}" type="application/pdf" width="600" height="800"></object>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="col-6">
          <div class="card card-default">
            <div class="card-header">
              <h3 class="card-title">{{$item->resol_admin}}</h3>
            </div>
            <div class="card-body">
              <div class="row">
                <div class="col-12">
                  <div class="container-iframe">
                  <!--<iframe class="responsive-iframe" width="600" height="1000" src="/doc-pac/" frameborder="0"></iframe>-->
                  <object data="/doc-pac/{{$item->archivo_resoladmin}}" type="application/pdf" width="600" height="800"></object>
                </div>
                </div>
              </div>
            </div>
