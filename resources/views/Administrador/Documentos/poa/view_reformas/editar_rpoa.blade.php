          ...
          <div class="col-12">
              <div class="card card-default">
                  <div class="card-header">
                      <h3 class="card-title">Editar POA Reformado</h3>
                      <div class="card-tools" id="card-tools">
                        <button type="button" class="btn btn-primary btn-block" onclick="urlback_ref({{$code}})"><i
                            class="fas fa-arrow-left mr-2"></i> Regresar</button>
                    </div>
                  </div>
                  <div class="card-body">
                      <form id="formE_POARef" action="" method="POST" enctype="multipart/form-data">
                          @foreach ($filepoa as $p)
                          <div class="row">
                              <div class="col-6">
                                  <div class="form-group noevent">
                                    <input type="hidden" name="idpoa" id="idpoa" value="{{$p->id}}">
                                    <label>Año:</label>
                                    <select class="form-control select2" id="selYearEPoa" name="selYearEPoa">
                                  ...
                                  <div class="card-list grid-card-list" id="cardListPoa">
                              ...
                              <div class="col-6">
                                  ...
                                  <div class="form-group mb-3 noshow" id="divfilepoa">
                          ...
                          <div class="row">
                              <div class="col-lg-12 mt-4 d-flex justify-content-end">
                                <button type="button" class="btn btn-primary" style="font-size: 16px;" onclick="actualizarrefpoa()">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-body text-center">
                ...
                <br><br>
                <p style="font-size: 16px;"> Actualizando POA... </p>
            </div>
        </div>
    </div>
</div>
