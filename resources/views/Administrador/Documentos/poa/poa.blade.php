          ...
          <div class="col-12">
              <div class="card">
                  <div class="card-header">
                      <h3 class="card-title p-2"><i class="fas fa-file-contract mr-3"></i> POA</h3>
                      <div class="card-tools" id="card-tools">
                          <button type="button" class="btn btn-primary btn-block" onclick="urlregistrarpoa()"><i
                      ...
                      <tbody>
                        ...
                        <tr id="Tr{{$loop->index}}">
                          ...
                          <td class="project-actions text-right">
                            <a class="btn btn-primary btn-sm mt-2 mr-3" href="javascript:void(0)" onclick="viewopenPOA({{$item->id}})">
                            ...
                            @if ($item->estado=='1')
                            <a class="btn btn-secondary btn-sm mt-2 mr-3" href="javascript:void(0)" onclick="inactivarPOA({{$item->id}}, {{$loop->index}})">
                              <i class="fas fa-eye-slash mr-3"></i>
                              Inactivar
                            </a>
                            @else
                            <a class="btn btn-secondary btn-sm mt-2 mr-3" href="javascript:void(0)" onclick="activarPOA({{$item->id}}, {{$loop->index}})">
