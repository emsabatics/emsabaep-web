          ...
          <div class="col-12">
              <div class="card card-default">
                  <div class="card-header">
                      <h3 class="card-title">Editar POA</h3>
                  ...
                  <div class="card-body">
                      <form id="formE_POA" action="" method="POST" enctype="multipart/form-data">
                              ...
                              <div class="col-6">
                                  ...
                                  <div class="form-group mt-4">
                                    <div class="custom-control custom-checkbox">
                                      ...
                                      <label for="checkReforma" class="custom-control-label">Reforma POA</label>
                                    </div>
                                  </div>
                              </div>
                              <div class="col-6">
                          ...
                          <div class="row">
                              <div class="col-lg-12 mt-4 d-flex justify-content-end">
                                <button type="button" class="btn btn-primary" style="font-size: 16px;" onclick="actualizarpoa()">
