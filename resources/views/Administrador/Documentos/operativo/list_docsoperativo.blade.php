          ...
          <div class="col-12">
              <div class="card">
                  <div class="card-header">
                      <div class="row">
                        <div class="col-7">
                          <h3 class="card-title p-2"><i class="fas fa-file-contract mr-3"></i> {{ $categoria }} \ {{ $subcategoria }}</h3>
                        </div>
                        <div class="col-5">
                          <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups" style="justify-content: flex-end;">
                            <div class="btn-group mr-2" role="group" aria-label="First group">
                              <button type="button" class="btn btn-primary btn-block" onclick="urlregistrardocoperativo('{{encriptarNumero($idcat)}}', '{{encriptarNumero($idsubcat)}}')"><i
                      ...
                      <tbody>
                        ...
                        <tr id="Tr{{$loop->index}}">
                          ...
                          <td class="project-actions text-right">
                            <a class="btn btn-primary btn-sm mt-2 mr-3" href="javascript:void(0)" onclick="viewopenDocOper('{{encriptarNumero($item->id)}}')">
                              <i class="fas fa-folder mr-2"></i>
                              Ver
                            </a>
                            <a class="btn btn-info btn-sm mt-2 mr-3" href="javascript:void(0)" onclick="interfaceupdateDocOper('{{encriptarNumero($item->id)}}')">
                              <i class="far fa-edit mr-2"></i>
                              Actualizar
                            </a>
                            @if ($item->estado=='1')
                            <a class="btn btn-secondary btn-sm mt-2 mr-3" href="javascript:void(0)" onclick="inactivarDocOper('{{encriptarNumero($item->id)}}', {{$loop->index}})">
                              <i class="fas fa-eye-slash mr-2"></i>
                              Inactivar
                            </a>
                            @else
                            <a class="btn btn-secondary btn-sm mt-2 mr-3" href="javascript:void(0)" onclick="activarDocOper('{{encriptarNumero($item->id)}}', {{$loop->index}})">
