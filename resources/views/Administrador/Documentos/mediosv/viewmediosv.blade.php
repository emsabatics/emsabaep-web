          ...
          <div class="col-12">
              <div class="card">
                  <div class="card-header">
                      <h3 class="card-title p-2"><i class="fas fa-file-contract mr-3"></i> Medios de Verificación</h3>
              ...
              <div class="row">
                <div class="col-12">
                  <div class="container-iframe">
                    <object data="/doc-medios-verificacion/{{$item->archivo}}" type="application/pdf" width="600" height="800"></object>
                  </div>
                </div>
              </div>
            </div>
