          ...
          <div class="col-12">
              <div class="card card-default">
                  <div class="card-header">
                      <h3 class="card-title">Registrar Medios de Verificación</h3>
                  ...
                  <div class="card-body">
                      <form id="formMediosV" action="" method="POST" enctype="multipart/form-data">
                          <div class="row">
                              <div class="col-6">
                                  <div class="form-group">
                                    <label>Año:</label>
                                    <select class="form-control select2" id="selYearMediosV" name="selYearMediosV">
                                  ...
                                  <div class="form-group" id="div-medio-title-doc">
                                    <label for="inputMTitle">Título: <span class="spanlabel"></span></label>
                                    <textarea class="form-control text-justify" id="inputMTitle" name="inputMTitle" placeholder="Ingrese un título"
                                      maxlength="255"></textarea>
                                  </div>
                              </div>
                              <div class="col-6">
                                <div class="form-group mb-3">
                                  <span class="spanlabel m-4" id="span-info-file">Seleccione los archivos</span>
                                  <div class="container">
                          ...
                          <div class="row">
                              <div class="col-lg-12 mt-4 d-flex justify-content-end">
                                <button type="button" class="btn btn-primary savemediosv" style="font-size: 16px;" onclick="guardarMediosV()">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-body text-center">
                ...
                <br><br>
                <p style="font-size: 16px;"> Registrando Medios de Verificación... </p>
            </div>
        </div>
    </div>
</div>
