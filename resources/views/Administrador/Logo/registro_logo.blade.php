            ...
            <div class="col-12">
                <div class="card card-default">
                    <div class="card-header">
                      ...
                      <div class="card-body">
                        <form id="formLogoImg" action="" method="POST" enctype="multipart/form-data">
                          <div class="row">
                          ...
                          <div class="row">
                            <div class="col-lg-12 mt-4 d-flex justify-content-end">
                              <button type="button" class="btn btn-primary" style="font-size: 16px;" onclick="guardarImagenes(event)" id="btnSaveImgLogo">
