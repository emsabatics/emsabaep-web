            ...
            <div class="col-12">
                <div class="card card-default">
                    <div class="card-header">
                        <h3 class="card-title">Registrar Imágenes - Alcaldía</h3>
                      ...
                      <div class="card-body">
                        <form id="formBannerImg" action="" method="POST" enctype="multipart/form-data">
                          <div class="row">
                            <div class="col-md-3"></div>
                            <div class="col-md-6">
                              <div class="form-group mb-3">
                                <div class="container">
                                  <input type="file" name="file[]" id="file" accept="image/*" onchange="previewBanner()" multiple>
                                  <label for="file">
                          ...
                          <div class="row">
                            <div class="col-lg-12 mt-4 d-flex justify-content-end">
                              <button type="button" class="btn btn-primary" style="font-size: 16px;" onclick="guardarImagenes(event)" id="btnSaveImgBanner">
