...
@section('title-page')
Admin | Banner {{getNameInstitucion()}}
@endsection
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <div class="cardsRowTitle">
                            <div class="cardsection">
                              <h3 class="card-title p-2"><i class="far fa-images mr-3"></i> Banner de Imágenes - Alcaldía</h3>
                            </div>
                            <div class="cardsection">
                              <button type="button" class="btn btn-secondary btn-block" onclick="openModalOrder()" id="btnOpenModalOrder"><i
                                class="fas fa-sort-numeric-up mr-2"></i> Orden de Visualización</button>
                            </div>
                            <div class="cardsection">
                    ...
                    <div class="card-body p-0" id="divTablaBanner">
...
data-keyboard="false" data-backdrop="static">
  <div class="modal-dialog modal-xl" role="document">
    <div class="modal-content">
      <div class="modal-header headerRegister headermodalBg">
        <h5 class="modal-title titletextheader" id="titleModal">Cambiar Orden de Visualización</h5>
        <button class="btn btn-danger" type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
...
<script src="{{asset('assets/administrador/js/banneralcaldia.js')}}"></script>
<script src="{{asset('assets/administrador/js/validacion.js')}}"></script>
<script>
    $('.select2').select2({
        theme: 'bootstrap4',
    });
    const nameInterfaz = "Banner de Alcaldía";
    toastr.options = {
      "closeButton": false,
      "debug": false,
      "newestOnTop": false,
    ...
    var resultadoArray = {{Illuminate\Support\Js::from($banner)}};
    var totalr = {{Illuminate\Support\Js::from($total_r)}};

    $(document).ready(function () {
      document.getElementById('btnOpenModalOrder').style.display='none';
      $('#modalCargando').modal('show');
      setTimeout(() => {
        //console.log(resultadoArray);
        cargar_banner(resultadoArray);
      }, 300);
    });
</script>
@endsection