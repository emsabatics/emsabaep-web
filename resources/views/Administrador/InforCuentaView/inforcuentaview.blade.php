                    ...
                    <div class="card-header">
                        <div class="cardsRowTitle">
                            <div class="cardsection">
                              <h3 class="card-title p-2"><i class="far fa-images mr-3"></i> Archivos</h3>
                            </div>
                            <div class="cardsection" id="divaggfilecuenta" style="display: none;">
...
<script>
    ...
    var resultadoArray = {{Illuminate\Support\Js::from($filecuenta)}};

    $(document).ready(function () {
      //$('#modalCargando').modal('show');
      setTimeout(() => {
        console.log(resultadoArray);
        cargar_archivos(resultadoArray);
      }, 300);
    });
</script>
@endsection