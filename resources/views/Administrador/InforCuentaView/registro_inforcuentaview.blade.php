...
@section('title-page')
Admin | Ajustes Cuenta {{getNameInstitucion()}}
@endsection
...
<div class="row mb-2">
  <div class="col-sm-12">
    <h1>Ajustes Detalle Infor Cuenta</h1>
  </div>
</div>
@endsection
            ...
            <div class="col-12">
                <div class="card card-default">
                    <div class="card-header">
                        <h3 class="card-title">Registrar Imágenes</h3>
                        <div class="card-tools">
                          <button type="button" class="btn btn-secondary btn-block" onclick="regresarVista()">
                            <i class="fas fa-arrow-circle-left mr-2"></i> Regresar
                          </button>
                        </div>
                      </div>
                      <div class="card-body">
                        <form id="formCuentaImg" action="" method="POST" enctype="multipart/form-data">
                          <div class="row">
                            <div class="col-md-3"></div>
                            <div class="col-md-6">
                              <div class="form-group mb-3">
                                <div class="container">
                                  <input type="file" name="file[]" id="file" accept="image/*, video/mp4" onchange="previewFileCuenta()" multiple>
                                  <label for="file">
                          ...
                          <div class="row">
                            <div class="col-lg-12 mt-4 d-flex justify-content-end">
                              <button type="button" class="btn btn-primary" style="font-size: 16px;" onclick="guardarImagenes(event)" id="btnSaveFileCuenta">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-body text-center">
                ...
                <br><br>
                <p style="font-size: 16px;"> Registrando Archivo... </p>
            </div>
        </div>
    </div>
</div>
...
<script src="{{asset('assets/administrador/js/settings_cuenta.js')}}"></script>
<script>
</script>
@endsection