      ...
      <div class="row">
          <div class="col-12">
              <div class="card card-primary card-outline">
                  ...
                  <div class="card-body">
                      <form id="formInforSubServicio" action="" method="POST" enctype="multipart/form-data">
                          <h4>Detalle</h4>
                          <div class="row">
                            <div class="col-lg-12">
                          ...
                          <h4 class="mt-5 mb-2">Archivos</h4>
                          <div class="row">
                            <div class="col-lg-6">
                            ...
                            <div class="col-lg-6">
                              <div class="form-group mb-3">
                                <label for="fileIcon">Previsualización: </label>
                                <div class="container">
                                  <div id="images"></div>
                                </div>
                              </div>
                          ...
                          <div class="row">
                              <div class="col-lg-12 mt-4 d-flex justify-content-end">
                                <button type="button" class="btn btn-primary saveinfosubservice" style="font-size: 16px;" onclick="guardarInforSubservicio()">
...
<script>
  ...
  var typeService='';
  var interface= {{Illuminate\Support\Js::from($interface)}};
