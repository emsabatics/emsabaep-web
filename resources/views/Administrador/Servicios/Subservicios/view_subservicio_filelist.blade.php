              ...
              <div class="card">
                  <div class="card-header">
                      ...
                      <div class="card-tools" id="card-tools">
                        ...
                        <button type="button" class="btn btn-primary btn-block" onclick="urlregistrarfilelist({{$idsubservice}})"><i
                  ...
                  <!-- /.card-header -->
                  <div class="card-body table-responsive p-4" id="divSubserviceTxtFile">
                    <table class="table datatables" id="tablaSubServiceTxtFile">
                      ...
                      <tbody>
                        ...
                        <tr id="TrSsInfo{{$loop->index}}">
                          ...
                          <td class="project-actions text-right">
                            <a class="btn btn-info btn-sm mt-2 mr-3" href="javascript:void(0)" onclick="interfaceupdateSubservicefilelist({{$item->id}})">
                              <i class="far fa-edit mr-2"></i>
                              Actualizar
                            </a>
                            @if ($item->estado=='1')
                            <a class="btn btn-secondary btn-sm mt-2 mr-3" href="javascript:void(0)" onclick="inactivarSubservicefilelist({{$item->id}}, {{$loop->index}})">
                              <i class="fas fa-eye-slash mr-2"></i>
                              Inactivar
                            </a>
                            @else
                            <a class="btn btn-secondary btn-sm mt-2 mr-3" href="javascript:void(0)" onclick="activarSubservicefilelist({{$item->id}}, {{$loop->index}})">
                              <i class="fas fa-eye mr-2"></i>
                              Activar
                            </a>
                            @endif
                            <a class="btn btn-danger btn-sm mt-2 mr-3" title="Eliminar" onclick="deleteSubservicefilelist({{$item->id}})">
