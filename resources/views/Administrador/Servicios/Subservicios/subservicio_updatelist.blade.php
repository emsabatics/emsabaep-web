      ...
      <div class="row">
          <div class="col-12">
              <div class="card card-primary card-outline">
                  ...
                  <div class="card-body">
                    @foreach($informacion as $it)
                    <h4>Título de la Lista</h4>
                    <div class="row">
                      <div class="col-lg-2">
                        <input type="hidden" name="idsubservice" id="idsubservice" value="{{$idsubservice}}">
                        <input type="hidden" name="idtablelist" id="idtablelist" value="{{$it->id}}">
                      </div>
                      <div class="col-lg-8">
                        <div class="form-group mt-4">
                          <label for="inputEditTitleListSubservice">Título: <span class="spanlabel">250 caracteres máximo</span></label>
                          <textarea class="form-control text-justify" id="inputEditTitleListSubservice" name="inputEditTitleListSubservice" placeholder="Ingrese un Título"
                            maxlength="250" rows="6" cols="5">{{$it->titulo}}</textarea>
                        </div>
                      </div>
                    ...
                    <div class="row">
                      <div class="col-lg-12">
                        <div class="form-group">
                          ...
                          <textarea id="summernoteEdit">{{$it->descripcion}}</textarea>
                        </div>
                      </div>
                    </div>
                    @endforeach
                    <div class="row">
                      <div class="col-lg-12 mt-4 d-flex justify-content-end">
                        <button type="button" class="btn btn-primary updatetitlesubservice" style="font-size: 16px;" onclick="actualizarListSubservicio()">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-body text-center">
                ...
                <br><br>
                <p style="font-size: 16px;"> Actualizando Información... </p>
            </div>
        </div>
    </div>
</div>
