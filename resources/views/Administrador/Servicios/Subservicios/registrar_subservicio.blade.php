          ...
          <div class="col-12">
              <div class="card card-default">
                  <div class="card-header">
                      <h3 class="card-title">Registrar Subservicio</h3>
                      <div class="card-tools" id="card-tools">
                        <button type="button" class="btn btn-primary btn-block" onclick="urlbackservicio()"><i
                            class="fas fa-arrow-left mr-2"></i> Regresar</button>
                    </div>
                  </div>
                  <div class="card-body">
                      <form id="formSubServicio" action="" method="POST" enctype="multipart/form-data">
                          <div class="row">
                            <div class="col-lg-4">
                              <div class="form-group noevent">
                                <input type="hidden" name="idservicio" id="idservicio" value="{{$idservicio}}">
                                <label for="inputTitleService">Servicio: </label>
                                <textarea class="form-control text-justify" id="inputTitleService" name="inputTitleService" placeholder="Ingrese un Título"
                                  maxlength="50" rows="4" cols="5">{{$nameservicio}}</textarea>
                              </div>
                              <div class="form-group">
                                <label>Tipo Registro:</label>
                                <select class="form-control select2" id="selTypeRegister" name="selTypeRegister">
                                  <optgroup label="Seleccione una Opción">
                                    ...
                                    <option value="lista_tramite">Trámites</option>
                                  </optgroup>
                                </select>
                              </div>
                            </div>
                            <div class="col-lg-8">
                              <div class="form-group mt-4">
                                <label for="inputTitleSubservice">Título del Subservicio: <span class="spanlabel">50 caracteres máximo</span></label>
                                <textarea class="form-control text-justify" id="inputTitleSubservice" name="inputTitleSubservice" placeholder="Ingrese un Título"
                          ...
                          <div class="row mt-4">
                            <div class="col-lg-6">
                              <div class="form-group mb-3">
                                <label for="file">Imagen del Subservicio: </label>
                                <div class="container">
                            ...
                            <div class="col-lg-6">
                              <div class="form-group mb-3">
                                <label for="fileIcon">ícono del Subservicio: </label>
                                <div class="container">
                          ...
                          <div class="row">
                              <div class="col-lg-12 mt-4 d-flex justify-content-end">
                                <button type="button" class="btn btn-primary savesubservice" style="font-size: 16px;" onclick="guardarSubservicio()">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-body text-center">
                ...
                <br><br>
                <p style="font-size: 16px;"> Registrando Subservicio... </p>
            </div>
        </div>
    </div>
</div>
